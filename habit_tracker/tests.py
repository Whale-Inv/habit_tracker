...
class HabitTestCase(APITestCase):
    ...
    def test_create_habit(self):
        ...
        self.assertEqual(
            response.json(),
            {'id': 2, 'habit_place': 'home', 'habit_time': '2026-04-10T20:45:00.731013+04:00',
             'habit_action': 'test action', 'sign_of_pleasant_habit': False, 'periodicity': 1, 'reward': None,
             'execution_duration': '00:01:30', 'is_public': True, 'creator': 1, 'related_habit': 1}
        )
    ...
    def test_habit_found_15_minutes_before(self):
        ...
        with patch('habit_tracker.tasks.send_telegram_message') as mock_send:
            ...
            mock_send.assert_called_once_with(
                '123456789',
                '🔔 Через 15 минут: Test habit в Home'
            )
